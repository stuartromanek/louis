...
The demo is a **separate production deployment** of the same Docker image as self-hosting. It uses a dedicated Yoto **public** client and maintainer-owned API keys. The editor UI is phone-capable (bottom tabs below 600px); desktop/tablet keep the two-column layout.
